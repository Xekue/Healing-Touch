...
public class TherapistApiController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TherapistResponseDto> updateTherapist(@PathVariable UUID id, @Valid @RequestBody TherapistResponseDto dto) {
    ...
    public ResponseEntity<Void> deleteTherapist(@PathVariable UUID id) {
        therapistService.softDeleteTherapist(id);
