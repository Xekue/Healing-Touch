...
public class AdminService {
    ...
    public void promoteToTherapist(UUID targetUserId, UUID adminId) {
        ...
        if (user.getRole() == UserRoles.ADMIN) {
            throw new IllegalStateException("Admins cannot be promoted to therapist.");
        }
    ...
    public void promoteToAdmin(UUID targetUserId, UUID adminId) {
        ...
        therapistRepository.findByUserId(user.getId()).ifPresent(t -> {
            t.setActive(false);
            t.setDeleted(true);
    ...
    public void demoteUser(UUID targetUserId, UUID adminId) {
        ...
        if (user.getRole() == UserRoles.ADMIN) {
            ...
            boolean hasActiveBookings = bookingRepository.existsByTherapistIdAndBookingStatusIn(
                    therapist.getId(),
